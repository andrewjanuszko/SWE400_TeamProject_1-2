...
public class FilterMetalCommand implements Command {
  ...
  public void execute() {
    ...
    try {
      /**
       * 1 = filter by name 2 = filter by inventory 3 = filter by inventory range 4 =
       * filter by atomicnumber 5 = filter by atomicmass 6 = filter by atomicmassrange
       * 7 = filter by acidrequired 8 = filter by acidrequiredrange 9 = filter by
       * dissolvedby
       */
      switch (filter[0]) {
      case ("1"): {
