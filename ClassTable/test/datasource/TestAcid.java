...
class TestAcid extends DatabaseTest {
  ...
  static void testGetName() throws SQLException, DatabaseException {
    AcidRowDataGateway acid1 = new AcidRowDataGatewayRDS(99, 2, "acidname1", "acidihabits1"),
  ...
  static void testGetSolute() throws SQLException, DatabaseException {
    AcidRowDataGateway acid1 = new AcidRowDataGatewayRDS(1, 2, "acidname1", "acidihabits1"),
  ...
  static void testDelete() {
    AcidRowDataGateway acid = new AcidRowDataGatewayRDS(1, 2, "chemname1", "cheminhabits1");
  ...
  static void testUpdate() throws SQLException, DatabaseException {
    ...
    AcidRowDataGateway acid_setter = new AcidRowDataGatewayRDS(1, 2, "acidname1", "acidinhabits1"),
