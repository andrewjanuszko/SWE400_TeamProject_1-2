...
class TestCompoundsMadeOf extends DatabaseTest {
  ...
  void testGetName() {
    ...
    CompoundsMadeOfTDG compound1 = new CompoundsMadeOfTDGRDS(1, madeOf1, "chemicalname1", 1.0);
    CompoundsMadeOfTDG compound2 = new CompoundsMadeOfTDGRDS(2, madeOf2, "chemicalname2", 1.0);
    CompoundsMadeOfTDG compound3 = new CompoundsMadeOfTDGRDS(3, madeOf3, "chemicalname3", 1.0);
  ...
  void testFindSetElementid() {
    ...
    // initialize compounds
    CompoundsMadeOfTDG compounds = new CompoundsMadeOfTDGRDS(1, madeOf, "chemicalname1", 1.0);

    ArrayList<CompoundDTO> list = compounds.findSetElementId(1);
  ...
  void TestFindCompoundId() {
    ...
    ArrayList<CompoundDTO> list1 = compound1.findSetElementId(1);
    ArrayList<CompoundDTO> expected1 = new ArrayList<CompoundDTO>();
    expected1.add(c1);
    assertEquals(expected1, list1);

    // Compound2
    ArrayList<CompoundDTO> list2 = compound1.findSetElementId(2);
